...
module.exports = {
  ...
  config: {root:'', port:8788, permissions:{read:true,edit:false,execute:false,capture:false}, commandConfirm:true, screenshotConfirm:true, editConfirm:true, tunnelProvider:'none'},
  active: false,
  confirm: async () => false,
